...
![Last-Commit](https://img.shields.io/github/last-commit/mikeroyal/google-cloud-guide?style=for-the-badge)
...
[OAuth2 for Go](https://github.com/golang/oauth2) is an oauth2 package contains a client implementation for OAuth 2.0 spec.

[Crane](rane is a FinOps Platform for Cloud Resource Analytics and Economics in Kubernetes clusters. The goal is not only help user to manage cloud cost easier but also ensure the quality of applications. ) is a FinOps Platform for Cloud Resource Analytics and Economics in Kubernetes clusters. The goal is not only help user to manage cloud cost easier but also ensure the quality of applications. 

[kube-bench](https://github.com/aquasecurity/kube-bench) is a tool that checks whether Kubernetes is deployed securely by running the checks documented in the [CIS Kubernetes Benchmark](https://www.cisecurity.org/benchmark/kubernetes/).
...
**[Start building with Node.js on Google Cloud](https://cloud.google.com/nodejs)**

**[Node.js Documentation](https://cloud.google.com/nodejs/docs/)**
...
**[Start building with Java on Google Cloud](https://cloud.google.com/java)**

**[Java Documentation](https://cloud.google.com/java/docs/)**
...
**[Start building with Go on Google Cloud](https://cloud.google.com/go)**

**[Go Documentation](https://cloud.google.com/go/docs/)**
...
**[Start building with Python on Google Cloud](https://cloud.google.com/python)**

**[Python Documentation](https://cloud.google.com/python/docs/)**
...
**[Start building with TypeScript on Google Cloud](https://cloud.google.com/compute/docs/tutorials/javascript-guide)**

**[Using TypeScript for Cloud Functions on Firebase](https://firebase.google.com/docs/functions/typescript)**
...
**[*unofficial* Google Cloud Storage API for Rust](https://docs.rs/cloud-storage/0.3.1/cloud_storage/)**

**[*unofficial* gCloud client for Rust](https://docs.rs/gcloud/0.1.4/gcloud/)**
